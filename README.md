...
Access to 68 agents, 289 skills, and 96 legacy command shims, plus hooks, rules, memory, continuous learning, and AgentShield security scanning. The agents are specialized for planning, review, build repair, security, architecture, and domain work.
...
|-- commands/         # 96 maintained slash-command shims
...
| Skills | 34 | `.agents/skills/`: SKILL.md + agents/openai.yaml per skill |
